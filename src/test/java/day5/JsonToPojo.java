...
public class JsonToPojo {
    ...
    public void testSpartanJsonToSpartanObject() {
        ...
        int newID = 5; //SecureSpartanTest.createRandomSpartan();
...
//        Spartan2 sp = new Spartan2(261,"Elma","Male",9999999998L)
    ...
    @Test
    public void gettingNestedJsonToPojo() {
        Response response = given()
                .log().all()
                .auth().basic("admin", "adminz")
        ...
        System.out.println("First girl Name " + jp.getString("content[0].name"));
        ...
        Spartan2 firstFemaleSpartan = jp.getObject("content[0]", Spartan2.class);
        System.out.println("firstFemaleSPartan = " + firstFemaleSpartan);

        //System.out.println("firstFeMaleSpartan = " + firstFeMaleSpartan);
        //System.out.println("The Spartan id from POJO is "       + firstMaleSpartan.getId() );
        System.out.println("The Spartan name from POJO is " + firstFemaleSpartan.getName());
        System.out.println("The Spartan gender from POJO is " + firstFemaleSpartan.getGender());
        System.out.println("The Spartan phone from POJO is " + firstFemaleSpartan.getPhone());
